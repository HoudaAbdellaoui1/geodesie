...
import home, l_arc6, menu_conversion, pb_dir_inv8, three_latitudes4, rcourbure5, surface_part7,ellipse1

from functions import *
import designer_wins.images_rc
import designer_wins.cart_to_geo
...
class Main2(QMainWindow):
    def __init__(self):
        ...
        self.ui = designer_wins.cart_to_geo.Ui_MainWindow()
        ...
        self.ui.btn_calculer.clicked.connect(lambda: self.convertcart())
        self.show()
    ...
    def convertcart(self):
        ...
        print("y=",y)
        print("z=",z)
        self.ui.phi_output.setText(str(conversion_cartogeo(x, y, z)[0]))
        self.ui.lambda_output.setText(str(conversion_cartogeo(x, y, z)[1]))
        self.ui.h_output.setText(str(conversion_cartogeo(x, y, z)[2]))
