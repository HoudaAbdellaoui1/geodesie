...
import ellipse1, rcourbure5, menu_conversion, pb_dir_inv8, three_latitudes4, home, surface_part7

from functions import *
import designer_wins.images_rc
import designer_wins.longueurs_darc
...
class Main6(QMainWindow):
    def __init__(self):
        ...
        self.ui = designer_wins.longueurs_darc.Ui_MainWindow()
        ...
        self.ui.btn_calculer.clicked.connect(lambda : self.meridien())
        self.ui.btn_calculer_2.clicked.connect(lambda : self.parallele())
    ...
    def slideLeftMenu(self):
        ...
        self.ui.Fct6_btn_2.clicked.connect(lambda: self.show())
        self.ui.Fct7_btn_2.clicked.connect(lambda: pb_dir_inv8.Main8().show())

    def meridien(self):
        phi = float(self.ui.phi_in.text())
        self.ui.S_output.setText(str(longueur_meridien(phi)))

    def parallele(self):
        phi = float(self.ui.phi_input.text())
        delta_l = float(self.ui.delta_lambda_input.text())
        self.ui.L_output.setText(str(longueur_parallele(phi,delta_l)))
